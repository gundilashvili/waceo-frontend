 ...
 export const MintSingle = (props) => {
  ...
  const handleSubmitRequest = async () => {
    try{ 
        ...
        if (!err) {  
            setIsLoading(true);
            const submitResponse = await props.mintAutoAllocationSingle( waceoAmount) 
  ...
  return (
    ...
    >
      <Card>
        ...
        title={  submitted ? "Successfully submitted!":   "Auto allocation mint"   }
        />
        <Divider />
        {!submitted ? (
            <CardContent>
